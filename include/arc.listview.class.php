...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<li class='hiddenInMobile'><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></li>\r\n";
        }
        else
        {
            $indexpage="<li class='hiddenInMobile'><a class='noAllowd' href='javascript:;'>首页</a></li>\r\n";
            $prepage.="<li><a class='noAllowd' href='javascript:;'>上一页</a></li>\r\n";
        }
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $endpage="<li class='hiddenInMobile'><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
            $nextpage.="<li><a class='noAllowd' href='javascript:;'>下一页</a></li>\r\n";
            $endpage="<li class='hiddenInMobile'><a class='noAllowd' href='javascript:;'>末页</a></li>\r\n";
        }
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<li><span class='cur'>$j</span></li>\r\n";
            }
            else
            {
                $listdd.="<li class='hiddenInMobile'><a href='".str_replace("{page}",$j,$tnamerule)."'>".$j."</a></li>\r\n";
            }
        }
        $plist = '';
