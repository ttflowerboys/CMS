...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg = $func;
        $rmsg .= "document.write(\"<br /><div style='width:450px;padding:0px;border:1px solid #1abc9c;'>";
        $rmsg .= "<div style='padding:6px;font-size:14px;color:#fff;background:#1abc9c';'><b>提示信息！</b></div>\");\r\n";
        $rmsg .= "document.write(\"<div style='min-height:130px;height:auto;font-size:10pt;background:#ffffff'><br />\");\r\n";
        ...
        if($onlymsg==0)
        {
            ...
            {
                $rmsg .= "<div style='margin-top:12px;'><a style='color:#1abc9c;' href='{$gourl}'>如果你的浏览器没反应，请点击这里...</a>";
                $rmsg .= "<br/></div></div>\");\r\n";
