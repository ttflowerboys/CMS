...
<div class="header">
	...
	<div class="txt"><script type="text/javascript" src="<?php echo $site_url; ?>/index.php?c=api&a=user"></script></div>
	<div class="tel">电话：<span>400-800-8888</span></div>
</div>

<div class="nav-bg">
		<ul id="nav" class="nav clearfix">
			<li class="nLi <?php if ($index) { ?>on<?php } ?>">
				<h3><a href="<?php echo $site_url; ?>">网站首页</a></h3>
			</li>
