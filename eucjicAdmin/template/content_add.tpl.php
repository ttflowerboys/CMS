...
<div class="subnav">
		...
		<tr>
			...
			<td><input type="text" class="input-text" size="120" id="title" value="<?php echo $data['title']; ?>" name="data[title]" onBlur="check_title()"><span id="title_text"></span></td>
		</tr>
		...
		<tr>
			...
			<td><?php  $field = new field();  echo $field->file('thumb',$data['thumb'],array('type'=>'gif,jpg,jpeg,png','preview'=>1,'size'=>0.5,'buttontxt'=>'上传图片')); ?></td>
		</tr>
