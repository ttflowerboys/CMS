...
<tbody>
	...
	<tr height="25">
		<td align="left">
		<input name="auth[site-index]" value="1" id="c_site" type="checkbox" onClick="setC('site')" <?php if ($auth['site-index']) echo 'checked' ?>>站点管理</td>
		<td align="left">
				<input class="c_block" name="auth[site-add]" type="checkbox" value="1" <?php if ($auth['site-add']) echo 'checked' ?> ><span>添加</span>
				<input class="c_block" name="auth[site-edit]" type="checkbox" value="1" <?php if ($auth['site-edit']) echo 'checked' ?> ><span>编辑</span>
				<input class="c_block" name="auth[site-del]" type="checkbox" value="1" <?php if ($auth['site-del']) echo 'checked' ?> ><span>删除</span>
		</td>
	</tr>
	<tr height="25">
		<td align="left">
