...
body { font: 12px 'Microsoft YaHei',tahoma, Arial, Verdana, sans-serif; color: #666666; }
...
.login { width: 520px; height: 302px; padding: 110px 130px 0px 290px; margin: 60px auto 0px auto; overflow: hidden; background: url(./img/login_bg.jpg) 0px 0px no-repeat; }
