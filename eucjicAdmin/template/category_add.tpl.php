	...
	<div class="bk10"></div>
		...
		<input type="hidden" value="<?php echo $catid; ?>" name="catid">
				<div class="col-tab">
					...
					<tbody>
					<tr>
						<th width="105"><font color="red">*</font>所属站点：</th>
						<td>
						<?php echo $this->catmark[$siteid]['language'];?>
						</td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" class="input-text" size="120" value="<?php echo $data['catname']; ?>" name="data[catname]" id="dir" onBlur="ajaxdir()"></td>
					</tr>
					<tr>
						<th><font color="red">*</font> 栏目目录：</th>
						<td><input type="text" class="input-text" size="80" value="<?php echo $data['catdir']; ?>" name="data[catdir]" id="dir_text"></td>
					</tr>
