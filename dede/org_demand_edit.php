...
if($dopost=="save" && $isarc == 1)
{
    ...
    $inQuery = "UPDATE `#@__org_demand` SET
    title   = '$title'   ,
    pubdate = '$pubDate' ,
    click   = '$click'   ,
    body    = '$body'    ,
    ...
    ShowMsg("编辑成功！","org_demand_main.php?issel=1&oid=".$cid."&aid=".$channelid);
...
//读取归档信息
$arcQuery = "SELECT * FROM `#@__org_demand` WHERE aid='$aid'";
...
include DedeInclude('templets/org_demand_edit.htm');